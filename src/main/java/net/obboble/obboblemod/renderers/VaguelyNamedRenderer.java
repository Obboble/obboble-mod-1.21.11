...
public class VaguelyNamedRenderer extends EntityRenderer<VaguelyNamed, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(VaguelyNamed entity, EntityRenderState state, float partialTick) {
